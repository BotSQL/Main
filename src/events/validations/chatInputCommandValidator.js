...
module.exports = async (client, interaction) => {
  ...
  if (commandObject.devOnly && !developersIds.includes(interaction.member.id)) {
  ...
  for (const permission of commandObject.botPemissions || []) {
    ...
    try {
      ...
      console.log(
        `[ERROR] - An error occurred inside th command registery:\n ${error}`
          .red
      );
    };
  };
